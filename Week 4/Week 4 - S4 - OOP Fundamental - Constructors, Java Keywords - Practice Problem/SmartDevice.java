public class SmartDevice {
    ...
    public static void main(String[] args) {
        ...
        SmartDevice device2 = new SmartDevice("Smart Light", "Bedroom", true, 7.2);
        SmartDevice device3 = new SmartDevice("Security Camera", "Entrance", false, 12.0);

        device1.performInitialSetup();
        device1.updateLocation("Hallway");
        device1.updatePowerConsumption(20.0);
        device1.setOnline(true).connectToDevice("Alexa").rename("Hall Thermostat");
        device1.displayDeviceInfo();

        device2.setOnline(false).connectToDevice("Google Home").rename("Bedroom Light");
        device2.displayDeviceInfo();

        device3.setOnline(true).connectToDevice("Smart Hub").rename("Front Door Camera");
